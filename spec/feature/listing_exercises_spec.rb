...
RSpec.feature "Listing Exercises" do 
	before do 
		...
		@e1 = @john.exercises.create(duration_in_min: 20, workout_type: "running", workout_date: "2016-08-09")
		@e2 = @john.exercises.create(duration_in_min: 20, workout_type: "weight lefting", workout_date: "2016-08-10")
	end
